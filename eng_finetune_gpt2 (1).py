# -*- coding: utf-8 -*-
"""Eng_fineTune_gpt2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1n3Czfh1HMSHzXwUzpbdcPPFl5XgR_mfS

## **Eng Fine-tune Gpt-2 "harry potter" model**
**We are going to fine-tune a eng GPT-2 from the Huggingface model hub. As fine-tune, data we are using the poets Dataset, which consists of 45000 lines from harry potter movie..**

**The idea is we use the harry potter book to fine-tune our GPT-2.**
"""
...
"""**the next step is to download the tokenizer, which we use. We use the tokenizer from the "gpt2" model on huggingface.**"""
...
thenewmodel = AutoModelWithLMHead.from_pretrained("gpt2")
theoriginalmodel = AutoModelWithLMHead.from_pretrained("gpt2")

training_args = TrainingArguments(
    output_dir="./gpt2-eng", #The output directory
...
trained_model = AutoModelWithLMHead.from_pretrained("./gpt2-eng")

"""### **model generate text generate text of the new model**"""

input_text = "Mr Dursley always sat with his"
...
import torch
torch.equal(vector1.cuda(),vector2.cuda())